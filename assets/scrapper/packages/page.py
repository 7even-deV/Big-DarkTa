...
try:
    ...
    from assets.scrapper.packages.common import requestAndParse
...
def extract_maximums(base_url):
    ...
    try:
        # Fixed the issue of "Assumptions invalid" given "Jobs" was changed to "jobs"
...
if __name__ == "__main__":
    ...
    print(f"[INFO] Maximum number of jobs in range: {maxJobs}, number of pages in range: {maxPages}")
